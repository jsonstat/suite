...
<script src="https://unpkg.com/jsonstat-suite@3.4.0"></script>
```

```html
<script src="https://cdn.jsdelivr.net/combine/npm/jsonstat-toolkit@1.4.2,npm/jsonstat-suite@3.4.0"></script>
```
...
```html
<script type="module">
import * as JSONstatUtils from "https://cdn.jsdelivr.net/npm/jsonstat-suite@3.4.0/import.mjs";
</script>
```

```html
<script type="module">
import * as JSONstatUtils from "https://unpkg.com/jsonstat-suite@3.4.0/import.mjs";
</script>
```
...
```js
JSONstatUtils = import("jsonstat-suite@3.4.0/import.mjs")
```
